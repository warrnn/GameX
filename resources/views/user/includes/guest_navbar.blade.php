    ...
    <div class="flex flex-wrap items-center justify-between mx-auto p-2 px-8">
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul class="font-medium flex p-4 md:p-0 mt-4 justify-end border border-gray-100 rounded-lg space-x-4 rtl:space-x-reverse md:mt-0 md:border-0">
                <li>
                    <a href="#" class="btn font-bold bg-neutral hover:bg-accent hover:text-black">Sign In</a>
                </li>
                <li>
                <a href="#" class="btn font-bold bg-neutral hover:bg-accent hover:text-black">Register</a>
                </li>
            </ul>
        </div>
    </div>
