    ...
    <div class="modal-box">
        ...
        <form action="" class="flex flex-col gap-4">
            ...
            <label class="input input-bordered flex items-center gap-2">
                ...
                <input type="text" class="grow border border-transparent focus:outline-none focus:ring-0 focus:border-transparent px-4 py-2 rounded" placeholder="Domicile" />
            </label>
            ...
            <label class="input input-bordered flex items-center gap-2">
                ...
                <input type="password" class="grow border border-transparent focus:outline-none focus:ring-0 focus:border-transparent px-4 py-2 rounded" placeholder="Confirm Password" />
            </label>

            <input type="submit" value="Register" class="btn w-full hover:bg-accent hover:text-black transition">
        </form>
