    ...
    <div class="modal-box bg-neutral">
        ...
        <form action="{{ route('guest.register') }}" method="POST" class="flex flex-col gap-4">
            ...
            <label class="input input-bordered flex items-center gap-2">
                ...
                <input type="text" name="name" class="grow border border-transparent focus:outline-none focus:ring-0 focus:border-transparent px-4 py-2 rounded" placeholder="Name" />
            </label>
