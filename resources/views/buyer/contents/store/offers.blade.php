...
<section class="mx-20">
    ...
    <div class="flex flex-col md:flex-row w-full mt-12 items-center">
        ...
        <form class="max-w-xs max-h-xs mx-auto mt-6 md:mt-0 md:ms-auto md:me-0 w-full">
            <label for="offer-search" class="mb-1 text-xs font-medium text-gray-900 sr-only">Search</label>
            <div class="relative">
                ...
                <input type="search" id="offer-search" class="block w-full p-2 ps-8 text-xs text-accent border border-gray-700 rounded-full bg-neutral focus:ring-accent focus:outline-none" placeholder="Search Game" required />
            </div>
        </form>
    </div>

    <!-- Discounted Games List -->
    <section id="discounted_games_results" class="h-auto flex flex-wrap justify-around gap-8 mt-8 pb-32">
